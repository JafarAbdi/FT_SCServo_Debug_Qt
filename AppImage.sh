#!/bin/bash
# Copied from https://github.com/facontidavide/PlotJuggler/blob/main/appimage/AppImage.sh
...
PATH=$PATH:linuxdeploy-plugin-qt/squashfs-root ./linuxdeploy/squashfs-root/AppRun --appdir $APPDIRPATH -d ../resources/FT_SCServo.desktop -i ../resources/FT_SCServo.png --plugin qt --output appimage
